...
func (r *repository) CreatePointHistory(ctx context.Context, payload *model.PointHistory) (*mongo.InsertOneResult, error) {
...
func (r *repository) GetPointHistories(ctx context.Context, offset int64, limit int64, filter *model.PointHistory) ([]model.PointHistory, error) {
...
func (r *repository) GetPointHistory(ctx context.Context, filter *model.PointHistory) (model.PointHistory, error) {
