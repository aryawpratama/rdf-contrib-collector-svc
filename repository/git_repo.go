...
func (r *repository) CreateGitRepo(ctx context.Context, payload *model.CmdGitRepo) (*mongo.InsertOneResult, error) {
...
func (r *repository) GetGitRepo(ctx context.Context, filter *bson.M) (model.GitRepo, error) {
...
func (r *repository) GetGitRepos(ctx context.Context, offset int64, limit int64, filter *bson.M) ([]model.GitRepo, error) {
...
func (r *repository) UpdateGitRepo(ctx context.Context, payload *model.CmdGitRepo, filter *bson.M) (*mongo.UpdateResult, error) {
	collection := r.mongo.Collection(r.col.GitRepos)
